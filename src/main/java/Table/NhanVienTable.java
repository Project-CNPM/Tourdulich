...
public class NhanVienTable {
    ...
    String[] TenCot = new String[]{"ID","Tên nhân viên", "Ngày sinh","Số điện thoại","Email","Chức vụ"};
   

    public void showTable(ArrayList<NhanVienModel> data,JTable table) {
